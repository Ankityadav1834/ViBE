...
def main():
    ...
    default_path = os.path.join("..", "simulation_result", "hetro_balancing", "results", "simulation_results.npz")
    ...
    plt.tight_layout()
    plt.savefig(os.path.join('..', 'simulation_result', 'hetro_balancing', 'custom_simulation_plots.png'), dpi=300)
